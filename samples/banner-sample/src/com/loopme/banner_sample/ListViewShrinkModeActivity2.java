...
public class ListViewShrinkModeActivity2 extends Activity implements LoopMeBanner.Listener,
        OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Adding listener to receive SDK notifications during the loading/displaying ad processes
		 */
        mBanner.setListener(this);
        RelativeLayout root = (RelativeLayout) findViewById(R.id.root_view);

		/*
		 * Optional: set up shrink mode
		 */
        ...
        mCustomAdapter.addBannerToPosition(6);
