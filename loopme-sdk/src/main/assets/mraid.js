...
(function() {
  ...
  bridge.nativeCallComplete = function(command) {
    console.log('nativeCallComplete');
  ...
  bridge.executeNativeCall = function(args) {
    ...
    console.log('executeNativeCall ' + command);
  ...
  bridge.notifyReadyEvent = function() {
    console.log('notifyReadyEvent');
    this.nativeSDKFiredReady = true;
    broadcastEvent(EVENTS.READY, 'Event ready');
  };
  ...
  bridge.notifyStateChangeEvent = function() {
    console.log('notifyStateChangeEvent');
  ...
  bridge.notifyViewableChangeEvent = function() {
    console.log('notifyViewableChangeEvent');
    broadcastEvent(EVENTS.INFO, 'Set isViewable to ' + stringify(isViewable));
    broadcastEvent(EVENTS.VIEWABLECHANGE, isViewable);
  };
  ...
  mraid.addEventListener = function(event, listener) {
    console.log('mraid.addEventListener');
    if (!event || !listener) {
  ...
  mraid.close = function() {
    ...
    //bridge.executeNativeCall(['close']);
        var iframe = document.createElement("IFRAME");
        iframe.setAttribute("src", "mraid://close");
        document.documentElement.appendChild(iframe);
        iframe.parentNode.removeChild(iframe);
        iframe = null;
    }
  ...
  mraid.getState = function() {
    console.log('mraid.getState ' + state);
    return state;
  };
...
//    bridge.executeNativeCall(['open', 'url', URL]);
  ...
  mraid.useCustomClose = function(shouldUseCustomClose) {
    ...
    var iframe = document.createElement("IFRAME");
    var command = "usecustomclose?shouldUseCustomClose=" + shouldUseCustomClose;
        iframe.setAttribute("src", "mraid://" + command);
        document.documentElement.appendChild(iframe);
        iframe.parentNode.removeChild(iframe);
        iframe = null;
  ...
  mraid.playVideo = function(uri) {
    console.log('mraid.playVideo ' + uri);
    if (!mraid.isViewable()) {
...
console.log("mraidBridge:" + window.mraidbridge);